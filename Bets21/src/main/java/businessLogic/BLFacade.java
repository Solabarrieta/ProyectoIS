...
public interface BLFacade  {
	...
	@WebMethod public boolean registrar(String login, String password);
	
	@WebMethod public String createPronostico(int n, String pronostico) throws PronosticoAlreadyExist;
